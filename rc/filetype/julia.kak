...
# Chars
add-highlighter shared/julia/char region (') (')  regions
add-highlighter shared/julia/char/ default-region fill comment
add-highlighter shared/julia/char/ region \B(\\\w+) \b fill value
#add-highlighter shared/julia/code/ regex ('\\?.')     0:string
# Comments
